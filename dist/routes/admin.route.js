...
// add Category
adminRouter.post("/add-event-category", authenticateJWT, authorizeRoles("admin"), upload.single("image"), validate(AddCategorySchema), addEventCategory);
// get all Categories
...
// +++++++++++++++++++ Event Apis start
// Adding Event
adminRouter.post("/add-event", authenticateJWT, authorizeRoles("admin"), upload.single("image"), validate(AddEventSchema), addEvent);
// Getting All Events
